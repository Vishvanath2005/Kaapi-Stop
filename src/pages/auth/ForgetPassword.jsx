...
const ForgotPassword = () => {
  ...
  return (
    <>
      <div className="relative font-layout-font flex flex-col justify-center items-center gap-6 bg-light-yellow   h-screen ">
        ...
        <div className="bg-white w-full max-w-lg p-8 rounded-xl shadow-lg">
          <div className="flex justify-between items-center py-4">
            ...
            <p className="text-xl font-bold text-center my-4 mr-6">Forgot Password?</p>
          </div>
          <form className="mx-4 mt-4">
            ...
            <p
              className=" cursor-pointer bg-dark-brown text-white text-center   w-full py-2 my-3 rounded-md text-lg font-semibold transition duration-200 "
            >
              Send Email
            </p>
          </form>
