          ...
          <div className="">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mx-5 text-xs flex lg:justify-end md:justify-center justify-center gap-2 mb-4">
                <button
                  type="submit"
                  className="flex gap-2 text-base items-center p-3 cursor-pointer px-6 bg-dark-brown text-white rounded"
                >
                  <IoSave size={23} />
                  Save
                </button>
          ...
          <div className="px-6 py-6">
            ...
            >
              ...
              <div className="flex justify-end mt-4">
                <button
                  type="submit"
                  className="flex items-center gap-2 px-6 py-2 bg-dark-brown text-white rounded"
                >
                  <IoSave size={20} /> Save
                </button>
              </div>
